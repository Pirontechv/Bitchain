...
"""Verify that starting bitchain with -h works as expected."""
import subprocess

from test_framework.test_framework import BitchainTestFramework
from test_framework.util import assert_equal

class HelpTest(BitchainTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitchain with -h for help text")
        ...
        self.log.info("Start bitchain with -version for version information")
