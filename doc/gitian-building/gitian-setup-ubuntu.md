...
The build script we'll be using is contained in the BITCHAIN github repository ([contrib/gitian-build.py](https://github.com/Pirontechv/Bitchain/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the BITCHAIN repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/BITCHAIN-Project/BITCHAIN/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, bitchain-detached-sigs, and bitchain GitHub repos.
