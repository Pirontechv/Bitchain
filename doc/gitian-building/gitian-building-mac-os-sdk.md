...
The script [extract-osx-sdk.sh](https://github.com/Pirontechv/Bitchain/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
bitchain/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/Pirontechv/Bitchain/blob/master/doc/README_osx.md) for troubleshooting tips.