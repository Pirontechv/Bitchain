...
/**
 * BITCHAIN RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzxbitseed(const UniValue& params, bool fHelp);
extern UniValue getzxbitseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzxbit(const UniValue& params, bool fHelp);
extern UniValue dzxbitstate(const UniValue& params, bool fHelp);
