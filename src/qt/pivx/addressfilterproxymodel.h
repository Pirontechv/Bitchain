...
#ifndef BITCHAIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define BITCHAIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //BITCHAIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
