...
#include "qt/bitchain/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/bitchain/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(BITCHAINGUI* _window, QWidget *parent) :
