...
#include "qt/bitchain/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(BITCHAINGUI* _window, QWidget *parent) :
