...
#ifndef BITCHAIN_QT_WALLETMODEL_H
#define BITCHAIN_QT_WALLETMODEL_H
...
/** Interface to BITCHAIN wallet from Qt view code. */
...
#endif // BITCHAIN_QT_WALLETMODEL_H
