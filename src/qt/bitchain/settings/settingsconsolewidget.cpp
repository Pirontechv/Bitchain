...
#include "qt/bitchain/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/bitchain/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(BITCHAINGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the BITCHAIN RPC console.") + "<br>" +
