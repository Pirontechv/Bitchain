...
#include "qt/bitchain/settings/settingsnetworkwidget.h"
#include "qt/bitchain/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/bitchain/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(BITCHAINGUI* _window, QWidget *parent) :
