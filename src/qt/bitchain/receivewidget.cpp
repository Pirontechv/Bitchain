...
#include "qt/bitchain/forms/ui_receivewidget.h"
...
#include "qt/bitchain/addressholder.h"
...
ReceiveWidget::ReceiveWidget(BITCHAINGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive XBIT."));
