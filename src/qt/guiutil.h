...
/** Utility functions used by the BITCHAIN Qt UI.
 */
namespace GUIUtil
{
...
// Render BITCHAIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZxbit = false);
...
// Parse "bitchain:" URI into recipient object, return true on successful parsing
