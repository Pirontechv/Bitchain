...
#ifndef BITCHAIN_ZXBITWALLET_H
#define BITCHAIN_ZXBITWALLET_H
...
public:
    CzXBITWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZXBIT(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZXBIT(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
