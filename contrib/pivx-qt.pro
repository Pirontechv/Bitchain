...
RESOURCES += src/qt/bitchain.qrc src/qt/bitchain_locale.qrc

TRANSLATIONS += src/qt/locale/bitchain_bg.ts \
                src/qt/locale/bitchain_de.ts \
                src/qt/locale/bitchain_en.ts \
                src/qt/locale/bitchain_es.ts \
                src/qt/locale/bitchain_fi.ts \
                src/qt/locale/bitchain_fr.ts \
                src/qt/locale/bitchain_it.ts \
                src/qt/locale/bitchain_ja.ts \
                src/qt/locale/bitchain_pl.ts \
                src/qt/locale/bitchain_pt.ts \
                src/qt/locale/bitchain_ru.ts \
                src/qt/locale/bitchain_sk.ts \
                src/qt/locale/bitchain_sv.ts \
                src/qt/locale/bitchain_vi.ts \
                src/qt/locale/bitchain_zh_CN.ts \
                src/qt/locale/bitchain_zh_TW.ts
