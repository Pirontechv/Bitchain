Contributing to BITCHAIN Core
============================

The BITCHAIN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/Pirontechv/Bitchain/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BITCHAIN Core project, and is not to be
confused with overall BITCHAIN Network Protocol consensus changes.

Whether a pull request is merged into BITCHAIN Core rests with the project merge
...
Patches that change BITCHAIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the BITCHAIN consensus, it must have been
...
The project leader is the release manager for each BITCHAIN Core release.
